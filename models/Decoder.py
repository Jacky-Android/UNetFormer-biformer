...
class Decoder(nn.Module):
    def __init__(self,
        ...
        self.b4 = Block(dim=decode_channels[-1], num_heads=encoder_channels[-1]//decode_channels[-3], window_size=window_size,topk=topks[2])

        self.b3 = Block(dim=decode_channels[-2], num_heads=encoder_channels[-2]//decode_channels[-3], window_size=window_size,topk=topks[1])
        self.p3 = WF(encoder_channels[-2], decode_channels)

        self.b2 = Block(dim=decode_channels[-3], num_heads=encoder_channels[-3]//decode_channels[-3], window_size=window_size,topk=topks[0])
