...
if __name__ == "__main__":
    imgs_dir = "G:/postam_orignal/dataset"
    masks_dir = "G:/postam_orignal/masks_po"
    ...
    img_paths.sort()
    mask_paths.sort()
    imgs_output_dir = 'G:/po_im'
    masks_output_dir = 'G:/po_mask'
    ...
    inp = [(img_path, mask_path, imgs_output_dir, masks_output_dir,  rgb_image,
            mode, split_size, stride)
           for img_path, mask_path in zip(img_paths, mask_paths)]
    mpp.Pool(processes=mp.cpu_count()).map(patch_format, inp[0])